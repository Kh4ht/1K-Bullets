...
namespace Michsky.UI.MTP
{
    public class UIGradient : BaseMeshEffect
    {
        [Header("Effect")]
        [SerializeField]
        private UnityEngine.Gradient _effectGradient = new()
        {
            ...
            if (stops.Count > 0)
            {
                ...
                for (int i = 0; i < nCount; i += 3)
                {
                    ...
                    if (ends.Count > 0)
                    {
                        ...
                        else if (starts.Count > 0) { helper.AddTriangle(vertexCount - 3, vertexCount - 1, vertexCount - 2); }
                    }
